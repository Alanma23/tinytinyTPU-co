...
#endif
            VL_FATAL_MT("/Users/alanma/Downloads/tinytinyTPU/rtl/mlp_top.sv", 6, "", "Settle region did not converge after 100 tries");
        }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)((triggers[0U] >> 1U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 1 is active: @(posedge mlp_top.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 2U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 2 is active: @(posedge mlp_top.weight_fifo_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 3U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 3 is active: @(posedge mlp_top.weight_fifo_u.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 4U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 4 is active: @(posedge mlp_top.ub_a.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 5U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 5 is active: @(posedge mlp_top.ub_a.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 6U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 6 is active: @(posedge mlp_top.ub_b.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 7U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 7 is active: @(posedge mlp_top.ub_b.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 8U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 8 is active: @(posedge mlp_top.mmu_u.pe00.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 9U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 9 is active: @(posedge mlp_top.mmu_u.pe00.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000000aU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 10 is active: @(posedge mlp_top.mmu_u.pe01.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000000bU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 11 is active: @(posedge mlp_top.mmu_u.pe01.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000000cU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 12 is active: @(posedge mlp_top.mmu_u.pe10.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000000dU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 13 is active: @(posedge mlp_top.mmu_u.pe10.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000000eU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 14 is active: @(posedge mlp_top.mmu_u.pe11.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000000fU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 15 is active: @(posedge mlp_top.mmu_u.pe11.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000010U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 16 is active: @(posedge mlp_top.accum_u.u_align.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000011U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 17 is active: @(posedge mlp_top.accum_u.u_align.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000012U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 18 is active: @(posedge mlp_top.accum_u.u_mem.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000013U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 19 is active: @(posedge mlp_top.accum_u.u_mem.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000014U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 20 is active: @(posedge mlp_top.ap_col0.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000015U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 21 is active: @(posedge mlp_top.ap_col0.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000016U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 22 is active: @(posedge mlp_top.ap_col0.act_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000017U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 23 is active: @(posedge mlp_top.ap_col0.act_u.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000018U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 24 is active: @(posedge mlp_top.ap_col0.norm_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000019U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 25 is active: @(posedge mlp_top.ap_col0.norm_u.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000001aU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 26 is active: @(posedge mlp_top.ap_col0.loss_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000001bU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 27 is active: @(posedge mlp_top.ap_col0.loss_u.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000001cU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 28 is active: @(posedge mlp_top.ap_col1.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000001dU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 29 is active: @(posedge mlp_top.ap_col1.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000001eU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 30 is active: @(posedge mlp_top.ap_col1.act_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x0000001fU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 31 is active: @(posedge mlp_top.ap_col1.act_u.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000020U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 32 is active: @(posedge mlp_top.ap_col1.norm_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000021U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 33 is active: @(posedge mlp_top.ap_col1.norm_u.reset)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000022U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 34 is active: @(posedge mlp_top.ap_col1.loss_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 0x00000023U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 35 is active: @(posedge mlp_top.ap_col1.loss_u.reset)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->mlp_top__DOT__ap_col0__DOT__mult = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 10691854389319009343ull);
    vlSelf->mlp_top__DOT__ap_col0__DOT__mult_rounded = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 16416695882664125112ull);
    vlSelf->mlp_top__DOT__ap_col0__DOT__scaled = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15781660909536457801ull);
    vlSelf->mlp_top__DOT__ap_col0__DOT__biased = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5365429184709226440ull);
    ...
    vlSelf->mlp_top__DOT__ap_col0__DOT__norm_u__DOT__mult = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 12503439240057102035ull);
    vlSelf->mlp_top__DOT__ap_col0__DOT__norm_u__DOT__shifted = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 11365012605581396777ull);
    ...
    vlSelf->mlp_top__DOT__ap_col1__DOT__mult = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 13748598521573381026ull);
    vlSelf->mlp_top__DOT__ap_col1__DOT__mult_rounded = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 8363288861851521139ull);
    vlSelf->mlp_top__DOT__ap_col1__DOT__scaled = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 4962817754645264580ull);
    vlSelf->mlp_top__DOT__ap_col1__DOT__biased = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7761887955149822551ull);
    ...
    vlSelf->mlp_top__DOT__ap_col1__DOT__norm_u__DOT__mult = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 2759065858129876681ull);
    vlSelf->mlp_top__DOT__ap_col1__DOT__norm_u__DOT__shifted = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 3341529782969307791ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6398567524560992608ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__weight_fifo_u__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8989610129472823231ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ub_a__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 491992216235747896ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ub_b__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1948999060333273677ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__mmu_u__DOT__pe00__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13771005739958800654ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__mmu_u__DOT__pe01__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2921498326831892231ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__mmu_u__DOT__pe10__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10079497404463585272ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__mmu_u__DOT__pe11__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17924773512293288156ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__accum_u__DOT__u_align__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6115992268983853338ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__accum_u__DOT__u_mem__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11777043262752899214ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ap_col0__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8793020332582018513ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ap_col0__DOT__act_u__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5814226951689838560ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ap_col0__DOT__norm_u__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7316893007640068668ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ap_col0__DOT__loss_u__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5213221171713637643ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ap_col1__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3952866816390622843ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ap_col1__DOT__act_u__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14334251007239271555ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ap_col1__DOT__norm_u__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6228589515872133419ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mlp_top__DOT__ap_col1__DOT__loss_u__DOT__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6659206061741769247ull);
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
