...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)((triggers[0U] >> 2U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 2 is active: @(posedge uart_controller.uart_rx_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 3U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 3 is active: @(posedge uart_controller.uart_rx_u.rst)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 4U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 4 is active: @(posedge uart_controller.uart_tx_u.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 5U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 5 is active: @(posedge uart_controller.uart_tx_u.rst)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->mlp_current_layer = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 10651191849553991710ull);
    vlSelf->mlp_layer_complete = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13611492752293024312ull);
    ...
    vlSelf->mlp_acc_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2064182270491288125ull);
    ...
    vlSelf->uart_controller__DOT__mlp_current_layer = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 17056770904393548845ull);
    vlSelf->uart_controller__DOT__mlp_layer_complete = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3489793790447893819ull);
    ...
    vlSelf->uart_controller__DOT__mlp_acc_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16659606611564429831ull);
    ...
    vlSelf->uart_controller__DOT__weight_seq_idx = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 8283618322867979297ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__uart_controller__DOT__uart_rx_u__DOT__rst__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3203582265713215908ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__uart_controller__DOT__uart_tx_u__DOT__rst__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 18426995213047861713ull);
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
