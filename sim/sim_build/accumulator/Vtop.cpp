...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , accumulator_enable{vlSymsp->TOP.accumulator_enable}
    , addr_sel{vlSymsp->TOP.addr_sel}
    , valid_out{vlSymsp->TOP.valid_out}
    , mmu_col0_in{vlSymsp->TOP.mmu_col0_in}
    , mmu_col1_in{vlSymsp->TOP.mmu_col1_in}
    , acc_col0_out{vlSymsp->TOP.acc_col0_out}
    , acc_col1_out{vlSymsp->TOP.acc_col1_out}
    , rootp{&(vlSymsp->TOP)}
{
