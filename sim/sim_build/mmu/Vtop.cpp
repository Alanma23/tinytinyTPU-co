...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , en_weight_pass{vlSymsp->TOP.en_weight_pass}
    , en_capture_col0{vlSymsp->TOP.en_capture_col0}
    , en_capture_col1{vlSymsp->TOP.en_capture_col1}
    , row0_in{vlSymsp->TOP.row0_in}
    , row1_in{vlSymsp->TOP.row1_in}
    , col0_in{vlSymsp->TOP.col0_in}
    , col1_in{vlSymsp->TOP.col1_in}
    , acc0_out{vlSymsp->TOP.acc0_out}
    , acc1_out{vlSymsp->TOP.acc1_out}
    , rootp{&(vlSymsp->TOP)}
{
