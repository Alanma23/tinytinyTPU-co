...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->popPrefix();
    tracep->pushPrefix("activation_func", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+13,0,"DEFAULT_ACT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    ...
    tracep->declBit(c+9,0,"valid_in",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+7,(vlSelfRef.activation_func__DOT__clk));
    bufp->fullBit(oldp+8,(vlSelfRef.activation_func__DOT__reset));
    bufp->fullBit(oldp+9,(vlSelfRef.activation_func__DOT__valid_in));
    bufp->fullIData(oldp+10,(vlSelfRef.activation_func__DOT__data_in),32);
    bufp->fullBit(oldp+11,(vlSelfRef.activation_func__DOT__valid_out));
    bufp->fullIData(oldp+12,(vlSelfRef.activation_func__DOT__data_out),32);
}
