...
module accumulator(
	input wire clk,
	input wire reset,
	input wire valid_in,  // MMU data valid
	input wire accumulator_enable, // add to existing sum or overwrite (1/0)
	input wire addr_sel, // buffer selection (buffer 1, or buffer 2)
	
	input wire [15:0] mmu_col0_in,
	input wire [15:0] mmu_col1_in,
	
	output wire signed [31:0] acc_col0_out,
	output wire signed [31:0] acc_col1_out,
